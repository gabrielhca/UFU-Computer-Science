/*
Defina um tipo de estrutura rotulada para representar números complexos 
da forma a+b.i, sendo a a parte real e b a imaginária. Em seguida, crie uma 
função para calcular a soma de dois números complexos e codifique um 
programa para testar seu funcionamento. Use atribuição para inicializar os 
campos membros das variáveis.
*/
